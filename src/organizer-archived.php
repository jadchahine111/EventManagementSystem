        ...
        <tbody>
            ...
            if ($resultAllArchivedEvents->num_rows > 0) {
                ...
                while ($row = $resultAllArchivedEvents->fetch_assoc()) {
                    ?>
                    <tr>                        <td data-label="ID"><?php echo $row['event_name']; ?></td>
                        ...
                        <td class="actions-cell">
                            ...
                            <div class="buttons right nowrap">
                                <a href="views-event-org.php?id=<?php echo $row['id']; ?>&source=organizer-archived.php" class="button small blue --jb-modal" data-target="sample-modal-2">
