...
if (isset($_GET['id'])) {
    ...
    if ($run_UserSql) {
        $userInfo = mysqli_fetch_assoc($run_UserSql);

        // Extract user information
        $profile_pic = $userInfo['profile_pic'];
        $first_name = $userInfo['first_name'];
        $last_name = $userInfo['last_name'];
        $file_no = $userInfo['file_no'];
  ...
  <div class="card">
        ...
        <?php endif; ?>
          ...
          <div class="field">
            ...
            <div class="control">
              <input type="text" readonly value="<?php echo $file_no; ?>" class="input is-static" name="last_name">
            </div>
          </div>
          ...
          <div class="field">
            ...
            <div class="control">
              <input type="email" readonly value="<?php echo $email1; ?>" class="input is-static" name="last_name">
            </div>
          </div>
          ...
          <div class="field">
            ...
            <div class="control">
              <input type="text" readonly value="<?php echo $major; ?>" class="input is-static" name="last_name">
            </div>
          </div>
          ...
          <div class="field">
            ...
            <div class="control">
              <input type="text" readonly value="<?php echo $status; ?>" class="input is-static" name="phone_number">
            </div>
          </div>
        </div>
      </div>
