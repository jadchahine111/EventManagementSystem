    ...
    <div class="navbar-end">
      ...
      <div class="navbar-item dropdown has-divider has-user-avatar">
        ...
        <?php
            ...
            echo '<a href="organizer-statistics.php" class="navbar-item">';
            echo '<span class="icon"><i class="mdi mdi-chart-areaspline"></i></span>';
            echo '<span>Statistics</span>';
            echo '</a>';

            // Show these items for non-administrators
            echo '<a href="organizer-pbevents.php" class="navbar-item">';
            echo '<span class="icon"><i class="mdi mdi-desktop-mac"></i></span>';
            echo '<span>Published Events</span>';
            echo '</a>';

            echo '<a href="organizer-pending.php" class="navbar-item">';
            echo '<span class="icon"><i class="mdi mdi-timetable"></i></span>';
            echo '<span>Pending Events</span>';
            echo '</a>';

            echo '<a href="organizer-archived.php" class="navbar-item">';
            echo '<span class="icon"><i class="mdi mdi-folder"></i></span>';
...
?>
    <a href="subscribed-users.php?id=<?php echo $eventId; ?>&source=<?php echo getAfterLink(); ?>" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
        Subscribed Users
    </a>
    <a href="paid-subscribed-users.php?id=<?php echo $eventId; ?>&source=<?php echo getAfterLink(); ?>" class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded">
